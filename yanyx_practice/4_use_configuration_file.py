...
config = {
    ...
    "train_data_path": "E:/Git_repo/allennlp-guide/quick_start/data/movie_review/train.tsv",
    "validation_data_path": "E:/Git_repo/allennlp-guide/quick_start/data/movie_review/dev.tsv",
    "model": {
